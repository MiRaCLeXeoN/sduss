...
class StableDiffusionEsymredPipelinePrepareInput:
    ...
    def prepare_prepare_input(
        ...
        **kwargs,
        ...
        sp: "StableDiffusionEsymredPipelineSamplingParams" = worker_req_list[0].sampling_params
...
@dataclass
class StableDiffusionEsymredPipelinePrepareOutput(BasePipelinePrepareOutput):
...
class StableDiffusionEsymredPipelineStepInput(BasePipelineStepInput):
    ...
    def prepare_step_input(
        ...
        **kwargs,
        ...
        input_dict["worker_reqs"] = input_worker_reqs
...
@dataclass
class StableDiffusionEsymredPipelineStepOutput:
    """Step output class.
...
@dataclass
class StableDiffusionEsymredPipelineOutput(BaseOutput):
    """
...
class StableDiffusionEsymredPipelineSamplingParams(BaseSamplingParams):
    ...
    utils_cls = {
        "prepare_input" : StableDiffusionEsymredPipelinePrepareInput,
        "prepare_output" : StableDiffusionEsymredPipelinePrepareOutput,
        "step_input" : StableDiffusionEsymredPipelineStepInput,
        "step_output" : StableDiffusionEsymredPipelineStepOutput,
        "post_input" : StableDiffusionEsymredPipelinePostInput,
        "pipeline_output" : StableDiffusionEsymredPipelineOutput,
    }
    ...
    def is_compatible_with(self, sampling_params: "StableDiffusionEsymredPipelineSamplingParams") -> bool:
        is_compatible = True
