...
def load_module(pipeline_pth: str, json_dict: Dict[str, List], kwargs: Dict) -> Dict:
...
def get_pipeline(pipeline_config: PipelineConfig) -> Any:
    ...
    with open(pipeline_pth + "/model_index.json") as f:
        ...
        sub_modules = load_module(pipeline_pth, json_file, pipeline_config.kwargs)
        
        pipeline = pipeline_cls(**sub_modules)
