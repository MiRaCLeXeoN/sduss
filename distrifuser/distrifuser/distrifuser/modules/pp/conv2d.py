            ...
            if self.is_first_layer:
                ...
                if self.buffer_list is None:
                    if self.comm_manager.buffer_list is None:
                        # Split horizontally
                        # This `2` stands for two boundaries, one with the above patch and one with the below
                        ...
                        # List[Tensor] of shape [2, B, C, boundary_size, W] * n_devices
                ...
                if self.buffer_list is None:
                    ...
                    # Boundary of my part, passing to others
